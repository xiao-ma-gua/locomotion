...
class CMUHumanoidObservables(legacy_base.WalkerObservables):
  ...
  def add_vector(self,
    ...
    def _global(physics, origin_callable=origin_callable):
      return world_frame_observable.observation_callable(physics)()

    self._observables[name] = observable.Generic(_global, **kwargs)
