...
def main():
    ...
    # 默认启动成年行人 9 - 变体 2
    # https://openhutb.github.io/doc/catalogue_pedestrians/#adult_pedestrian_9_variant_2
    argparser.add_argument(
        '--filter',
        metavar='PATTERN',
        default='walker.pedestrian.0029',
        help='actor filter (default: "walker.pedestrian.0029")')
    argparser.add_argument(
        '--generation',
        metavar='G',
        default='2',
