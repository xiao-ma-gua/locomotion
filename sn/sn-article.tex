...
Actuators of the fly model in its default configuration. 
Task-specific model modifications (e.g., disabling legs for flight) may include removing some of the actuators. 
By default, each actuator actuates one DoF. 
In the “position coupled” category, one actuator actuates several DoFs coupled by a MuJoCo tendon.
