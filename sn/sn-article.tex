...
For instance, the reward is zero when the CoM displacement in the first term $ \mathbf{r} \mathbf{r}^{*} > \delta_\text{com} $, while it is one when $ || \mathbf{r} - \mathbf{r}^{*} || $, and similarly for the second term. 
