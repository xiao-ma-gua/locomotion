...
\end{equation}
% 
$ E_\text{com} $ measures the similarity between the current model and reference Cartesian CoM positions, $ r_\text{com} $ and r ?com. 
Equat measures the similarity between the model and reference joint quaternions qi and qi ? for all joints, including the root joint. 
...
Eqvel expresses the similarity between the model and reference joint velocities, vi and vi ? . 
Eee compares the Cartesian positions of the end-effectors (six leg tips), ri and r ?i . 
